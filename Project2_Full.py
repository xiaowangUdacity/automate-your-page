...
#example_context = '''LESSON: abbkkd. TITLE: dfljf DESCRIPTION: fshfdsl. TITLE: fskhda DESCRIPTION: fdskuhfa;ejvjfduff. LESSON: gfdkh TITLE: dfsdkj DESCRIPTION: dfshhjgbkhkkf.'''
...
<html>
    ...
    while i <= len(list_of_contents)-1:
        if list_of_contents[i][0] != temp_lesson:
            ...
            html_0 = html_0 + html_row_begin + html_lesson_begin+html_lesson_end+html_title_begin
        html_title = ""
        html_description = ""
        ...
        html_0 = html_0 + html_title + html_description
        if (i < len(list_of_contents) - 1) and (list_of_contents[i][0] != list_of_contents[i+1][0]):
            html_title_end = '''
                </div>'''
            html_row_end = '''
            </div>'''
            html_0 = html_0 + html_title_end + html_row_end
